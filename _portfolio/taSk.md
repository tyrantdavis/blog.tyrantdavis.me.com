...
<h3 class="w3-container w3-grey bold w3-text-white w3-opacity w3-wide">Problem</h3>
...
<h3 class="w3-container w3-black bold w3-opacity w3-wide">User Requirements</h3>
...
<h3 class="w3-container w3-grey bold w3-text-white w3-wide">Solution</h3>
...
<h3 class="w3-container w3-red bold w3-text-white w3-opacity w3-wide">Conclusion</h3>
...
<h3 class="w3-container w3-black bold w3-opacity w3-wide">Post Completion Updates</h3>
####	 Added Features
